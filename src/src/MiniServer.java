...
public class MiniServer implements Runnable {
    ...
    public static void main(String[] args){
        ...
        MiniServer miniServer = MiniServer.singletonMiniServer(new File(path),port);
        Thread miniServerThread = new Thread(miniServer);
        miniServerThread.setDaemon(true);
        miniServerThread.run();
    }
...
//                    }
    ...
    public static MiniServer singletonMiniServer(File root,int port){
        if (myServer == null){
            myServer = new MiniServer(root,port);
        }
        return myServer;
    }
    private MiniServer(File root,int port){
        this.rootDir = root;
